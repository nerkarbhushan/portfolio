        ...
        <div className="grid sm:grid-cols-2 items-start gap-12 p-8 mx-auto max-w-5xl bg-gradient-to-b from-slate-900 rounded-md">
          ...
          >
            ...
            <button
              disabled={isDisabled}
              type="submit"
              className="rounded-md text-sm px-4 py-2.5 w-full !mt-6 bg-gradient-to-br from-blue-500 via-purple-500 to-pink-500 hover:bg-slate-200 text-white mr-4"
            >
              Message
            </button>
          </form>
          <div className="relative h-full">
            <Image src="/assets/contact.svg" alt="Contact" fill={true} />
          </div>
        </div>
      </div>
      {toast.visible ? (
